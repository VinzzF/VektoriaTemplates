...
void CGame::Tick(float fTime, float fTimeDelta)
{
	...
	if (m_zr.IsTime(20.0f))
	{
		...
		m_azwAdditionalText[1].PrintF("ACHTUNG: Ich erhoehe gleich die Texturaufloesungen.",20, 146);
		m_azwAdditionalText[2].PrintF("Falls es dann crashen sollte, haben Sie einen extrem");
		m_azwAdditionalText[3].PrintF("kleinen Texturspeicher, reduzieren Sie die Aufloesungen!", 146);
